function Phonewrap(sourceId, wrapperId) {
...
Phonewrap.prototype.model = function(str) {
	
	if (typeof str !== 'undefined' && str === 'string') {
		color = str;
		return color;
	}
	else return color;
...
/*
Phonewrap.prototype.fullscreen = function(bool) {
...
var Phone = {
	...
	wrap : function(source, output, isFullscreen) {
		...
		var container = document.createElement('div'),
			containerMarkup = '',
			containerTarget = source.parentNode;
			viewport = {}, 
		...
		// Add the new container to the source's parent node
		viewportContents.parentNode.appendChild(container);
